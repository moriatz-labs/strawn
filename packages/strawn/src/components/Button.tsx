...
export function Button({ children, leftIcon, rightIcon, loading = false, disabled, type = "button", ...props }: ButtonProps) {
    const ButtonComponent = StyledButton as unknown as ElementType;
    return (<ButtonComponent type={type} disabled={disabled || loading} aria-busy={loading || undefined} data-loading={loading || undefined} {...props}>
